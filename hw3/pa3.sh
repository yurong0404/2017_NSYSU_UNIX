...
alias score='echo You have scored `ls -1 ~/pa3/treasures/gold ~/pa3/treasures/platinum ~/pa3/treasures/diamond ~/pa3/treasures/bracelet 2> ~/X | wc -l | xargs expr 10 \*` points out of 90 possible points.'
alias flush='ls urinal >& ~/X|| echo "You cannot flush here.";ls urinal >& ~/X && (mv ~/pa3/holdtreasure/* ~/pa3/treasures >& ~/X;echo Whoosh\!!;echo ;score) ' 
