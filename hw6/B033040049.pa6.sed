...
#  Empty                                                                      #
#PS:                                                                          #
#  Everything from the input line modified by the following rules:            #
#    "\\"  ->  "#"                                                            #
#    "\["  ->  "%@"                                                           #
#    "\ "  ->  "%_"                                                           #
#    "\"   ->  "%"                                                            #
...
###############################################################################
# The following line now: 1) isolates and 2) processes the leftmost "[...]".  #
#  1. To begin isolating the "...", replace the "]" with a "\n". But that is  #
...
#HS (holds 3 lines):                                                          #
#   Everything before the leftmost "["                                        #
#   Everything inside of the leftmost "[...]"                                 #
#   Everything after the "]" that closes out the leftmost "[...]"             #
#PS:                                                                          #
#   Everything inside the leftmost "[...]", but with each " " converted to a  #
...
###############################################################################
# Finally, we replace each "&" with the end-of-line-allowing pattern:         #
###############################################################################
#s, ,[\\n\\t\\r ][\\n\\t\\r ]*,g
###############################################################################
